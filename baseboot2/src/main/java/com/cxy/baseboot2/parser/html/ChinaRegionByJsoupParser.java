...
public class ChinaRegionByJsoupParser {
    ...
    private static void deal2Region(RegionEntry province) {
        ...
        String basePath = "E:/GitLocal/SmartGit/cxy/springboot/baseboot2/db/mysql/initsql/datainit/chinaRegion/" + province.getCode() + ".sql";
    ...
    private static Document getDocument(String url) {
        ...
        while (null == doc) {
            try {
                ...
                i++;
                System.err.println("获取[" + url + "]Document 错误次数:" + i);
                e.printStackTrace();
            }
        }
        return doc;
